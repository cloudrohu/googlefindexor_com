...
class CompanyCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Use an unsaved Company instance for initial (new) inline formsets
        ...
        if self.request.POST:
            ...
            # Important: pass instance=empty_company so empty_form & management_form render properly
    ...
    def form_valid(self, form):
        ...
        # instantiate formsets with real saved instance for POST
        ...
        # (your existing saving logic is fine — keep it)
        ...
        return response
